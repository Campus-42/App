...
=======
export declare const KeyboardAccessoryView: React.MemoExoticComponent<({ children, contentContainerStyle, contentOffsetKeyboardClosed, contentOffsetKeyboardOpened, renderBackground, renderScrollable, spaceBetweenKeyboardAndAccessoryView, style, useListenersOnAndroid, }: Props) => JSX.Element>;
>>>>>>> Stashed changes
export {};
