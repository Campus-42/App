...
function format(maybeMessage) {
  ...
  var formatted = _typeof(maybeMessage) === 'symbol' ? maybeMessage.toString() : '' + maybeMessage; // If the first argument is a string, check for substitutions.
  ...
  if (args.length) {
    for (var i = 0; i < args.length; i++) {
      ...
      formatted += ' ' + (_typeof(arg) === 'symbol' ? arg.toString() : arg);
    }
...
/* harmony import */ var react_devtools_feature_flags__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9);
...
var OVERRIDE_CONSOLE_METHODS = ['error', 'trace', 'warn', 'log'];
...
function registerRenderer(renderer, onErrorOrWarning) {
  var currentDispatcherRef = renderer.currentDispatcherRef,
      ...
      getIsStrictMode = renderer.getIsStrictMode,
  ...
  if (currentDispatcherRef != null && typeof getCurrentFiber === 'function') {
    ...
    injectedRenderers.set(renderer, {
      ...
      getIsStrictMode: getIsStrictMode,
  ...
  OVERRIDE_CONSOLE_METHODS.forEach(function (method) {
    try {
      ...
      var overrideMethod = function overrideMethod() {
        ...
        var isInStrictMode = false; // Search for the first renderer that has a current Fiber.
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var _step$value = _step.value,
                ...
                getIsStrictMode = _step$value.getIsStrictMode;
        ...
        if (react_devtools_feature_flags__WEBPACK_IMPORTED_MODULE_3__[/* consoleManagedByDevToolsDuringStrictMode */ "a"] && isInStrictMode) {
          if (!consoleSettingsRef.hideConsoleLogsInStrictMode) {
            ...
            if (isNode) {
              ...
              if (color) {
                originalMethod("%c".concat(_utils__WEBPACK_IMPORTED_MODULE_0__[/* format */ "f"].apply(void 0, args)), "color: ".concat(color));
              } else {
...
var DevToolsFeatureFlags_core_oss = __webpack_require__(9);
...
function attach(hook, rendererID, renderer, global) {
  ...
  function flushPendingEvents(root) {
    ...
    pendingStringTable.forEach(function (value, key) {
      ...
      var encodedKey = Object(utils["m" /* utfEncodeString */])(key);
...
exports.version = "17.0.3-experimental-2a7bb4154";
...
<<<<<<< Updated upstream
  ...
  function format(maybeMessage) {
    if (DevToolsFeatureFlags_core_oss["a" /* consoleManagedByDevToolsDuringStrictMode */]) {
      for (var _len = arguments.length, inputArgs = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
        inputArgs[_key - 1] = arguments[_key];
      }
      ...
      var formatted = hook_typeof(maybeMessage) === 'symbol' ? maybeMessage.toString() : '' + maybeMessage; // If the first argument is a string, check for substitutions.
      ...
      if (args.length) {
        for (var i = 0; i < args.length; i++) {
          ...
          formatted += ' ' + (hook_typeof(arg) === 'symbol' ? arg.toString() : arg);
        }
      } // Update escaped %% values.
  ...
  function patchConsoleForInitialRenderInExtension(renderer, _ref) {
    ...
    if (DevToolsFeatureFlags_core_oss["a" /* consoleManagedByDevToolsDuringStrictMode */]) {
      ...
      if (false) { var originalConsoleMethods, targetConsole; }
    }
=======
>>>>>>> Stashed changes
  }
...
<<<<<<< Updated upstream
        if (true) {
          Object(backend_console["b" /* registerRenderer */])(renderer);
          Object(backend_console["a" /* patch */])({
            appendComponentStack: appendComponentStack,
            breakOnConsoleErrors: breakOnConsoleErrors,
            showInlineWarningsAndErrors: showInlineWarningsAndErrors,
