...
=======
export declare const check: (permission: import("./types").Permission) => Promise<"unavailable" | "blocked" | "denied" | "granted" | "limited">;
export declare const checkLocationAccuracy: () => Promise<import("./types").LocationAccuracy>;
export declare const checkMultiple: <P extends import("./types").Permission[]>(permissions: P) => Promise<Record<P[number], "unavailable" | "blocked" | "denied" | "granted" | "limited">>;
export declare const checkNotifications: () => Promise<import("./types").NotificationsResponse>;
export declare const openLimitedPhotoLibraryPicker: () => Promise<void>;
export declare const openSettings: () => Promise<void>;
export declare const request: (permission: import("./types").Permission, rationale?: import("react-native").Rationale | undefined) => Promise<"unavailable" | "blocked" | "denied" | "granted" | "limited">;
export declare const requestLocationAccuracy: (options: import("./types").LocationAccuracyOptions) => Promise<import("./types").LocationAccuracy>;
export declare const requestMultiple: <P extends import("./types").Permission[]>(permissions: P) => Promise<Record<P[number], "unavailable" | "blocked" | "denied" | "granted" | "limited">>;
>>>>>>> Stashed changes
...
=======
    check: (permission: import("./types").Permission) => Promise<"unavailable" | "blocked" | "denied" | "granted" | "limited">;
    checkLocationAccuracy: () => Promise<import("./types").LocationAccuracy>;
    checkMultiple: <P extends import("./types").Permission[]>(permissions: P) => Promise<Record<P[number], "unavailable" | "blocked" | "denied" | "granted" | "limited">>;
    checkNotifications: () => Promise<import("./types").NotificationsResponse>;
    openLimitedPhotoLibraryPicker: () => Promise<void>;
    openSettings: () => Promise<void>;
    request: (permission: import("./types").Permission, rationale?: import("react-native").Rationale | undefined) => Promise<"unavailable" | "blocked" | "denied" | "granted" | "limited">;
    requestLocationAccuracy: (options: import("./types").LocationAccuracyOptions) => Promise<import("./types").LocationAccuracy>;
    requestMultiple: <P_1 extends import("./types").Permission[]>(permissions: P_1) => Promise<Record<P_1[number], "unavailable" | "blocked" | "denied" | "granted" | "limited">>;
>>>>>>> Stashed changes
