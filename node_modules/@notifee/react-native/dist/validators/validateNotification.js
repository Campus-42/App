...
const validatePlatformSpecificNotification = (out, specifiedPlatform) => {
    try {
        if (specifiedPlatform === 'ios') {
            return validateIOSNotification_1.default(out.ios);
        }
        else {
            return validateAndroidNotification_1.default(out.android);
        }
    }
    catch (error) {
...
<<<<<<< Updated upstream
        if (notification.title !== undefined && !utils_1.isString(notification.title)) {
...
<<<<<<< Updated upstream
        if (notification.body !== undefined && !utils_1.isString(notification.body)) {
...
<<<<<<< Updated upstream
        if (notification.subtitle !== undefined && !utils_1.isString(notification.subtitle)) {
...
>>>>>>> Stashed changes
     ...
     */
<<<<<<< Updated upstream
    const validatedAndroid = exports.validatePlatformSpecificNotification(notification, 'android');
    if (utils_1.isAndroid) {
=======
...
>>>>>>> Stashed changes
     ...
     */
<<<<<<< Updated upstream
    const validatedIOS = exports.validatePlatformSpecificNotification(notification, 'ios');
=======
