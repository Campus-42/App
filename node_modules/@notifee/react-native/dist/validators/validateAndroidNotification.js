...
>>>>>>> Stashed changes
    ...
    if (utils_1.objectHasProperty(android, 'largeIcon')) {
        ...
        if (utils_1.isBoolean(android.circularLargeIcon)) {
     ...
     * fullScreenAction
     */
    if (utils_1.objectHasProperty(android, 'fullScreenAction') && !utils_1.isUndefined(android.fullScreenAction)) {
        try {
            out.fullScreenAction = validateAndroidFullScreenAction_1.default(android.fullScreenAction);
        }
        catch (e) {
