...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
    if (utils_1.objectHasProperty(trigger, 'repeatFrequency') && !utils_1.isUndefined(trigger.repeatFrequency)) {
=======
...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
    if (utils_1.objectHasProperty(trigger, 'alarmManager') && !utils_1.isUndefined(trigger.alarmManager)) {
        if (utils_1.isBoolean(trigger.alarmManager)) {
...
function validateTimestampAlarmManager(alarmManager) {
    ...
    if (utils_1.isBoolean(alarmManager.allowWhileIdle) && alarmManager.allowWhileIdle) {
...
<<<<<<< Updated upstream
<<<<<<< Updated upstream
    if (utils_1.objectHasProperty(trigger, 'timeUnit') && !utils_1.isUndefined(trigger.timeUnit)) {
=======
