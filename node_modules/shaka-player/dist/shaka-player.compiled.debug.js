...
goog.exportProperty(shaka.util.AbortableOperation.prototype,"chain",shaka.util.AbortableOperation.prototype.chain);shaka.util.AbortableOperation.wrapChainCallback_=function(a,b,c){try{var d=a(b);if(d&&d.promise&&d.abort)return c.resolve(d.promise),function(){return d.abort()};c.resolve(d);return function(){return Promise.resolve(d).then(function(){},function(){})}}catch(e){return c.reject(e),function(){return Promise.resolve()}}};shaka.util.FakeEvent=function(a,b){b=void 0===b?{}:b;for(var c in b)this[c]=b[c];this.defaultPrevented=this.cancelable=this.bubbles=!1;this.timeStamp=window.performance&&window.performance.now?window.performance.now():Date.now();this.type=a;this.isTrusted=!1;this.target=this.currentTarget=null;this.stopped=!1};goog.exportSymbol("shaka.util.FakeEvent",shaka.util.FakeEvent);shaka.util.FakeEvent.prototype.preventDefault=function(){this.cancelable&&(this.defaultPrevented=!0)};
...
"uz"],["ven","ve"],["vie","vi"],["vol","vo"],["wel","cy"],["wln","wa"],["wol","wo"],["xho","xh"],["yid","yi"],["yor","yo"],["zha","za"],["zho","zh"],["zul","zu"]]);shaka.util.StreamUtils={};
...
shaka.util.Pssh.normaliseInitData=function(a){if(!a)return a;var b=new shaka.util.Pssh(a);if(1>=b.data.length)return a;a=[];var c={};b=$jscomp.makeIterator(b.data);for(var d=b.next();!d.done;c={initData$227:c.initData$227},d=b.next())c.initData$227=d.value,a.some(function(a){return function(b){return shaka.util.Uint8ArrayUtils.equal(b,a.initData$227)}}(c))||a.push(c.initData$227);return shaka.util.Uint8ArrayUtils.concat.apply(shaka.util.Uint8ArrayUtils,$jscomp.arrayFromIterable(a))};shaka.util.XmlUtils={};shaka.util.XmlUtils.findChild=function(a,b){var c=shaka.util.XmlUtils.findChildren(a,b);return 1!=c.length?null:c[0]};shaka.util.XmlUtils.findChildNS=function(a,b,c){a=shaka.util.XmlUtils.findChildrenNS(a,b,c);return 1!=a.length?null:a[0]};shaka.util.XmlUtils.findChildren=function(a,b){return Array.prototype.filter.call(a.childNodes,function(a){return a instanceof Element&&a.tagName==b})};
...
shaka.dash.DashParser.prototype.processManifest_=function(a,b){var c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){var f,g,h,k,l,m,n,q,p,t,r,v,u,y,w,x,G,D,H,C,z,A,E,F,B;return $jscomp.generator.createGenerator(e,function(e){switch(e.nextAddress){case 1:f=shaka.util.Functional;g=shaka.util.XmlUtils;h=[b];k=g.findChildren(a,"Location").map(g.getContents).filter(f.isNotNull);0<k.length&&(l=shaka.util.ManifestParserUtils.resolveUris(h,k),h=c.manifestUris_=l);m=g.findChildren(a,
...
y||(w=g.parseAttr(a,"suggestedPresentationDelay",g.parseDuration));c.manifest_?x=c.manifest_.presentationTimeline:(G=Math.max(c.config_.dash.defaultPresentationDelay,1.5*p),D=null!=w?w:G,x=new shaka.media.PresentationTimeline(t,D,c.config_.dash.autoCorrectDrift));H={dynamic:"static"!=u,presentationTimeline:x,period:null,periodInfo:null,adaptationSet:null,representation:null,bandwidth:0,indexRangeWarningGiven:!1};C=c.parsePeriods_(H,n,a);z=C.duration;A=C.periods;x.setStatic("static"==u);"static"!=
u&&C.durationDerivedFromPeriods||x.setDuration(z||Infinity);(E=x.isLive())&&!isNaN(c.config_.availabilityWindowOverride)&&(r=c.config_.availabilityWindowOverride);null==r&&(r=Infinity);x.setSegmentAvailabilityDuration(r);x.notifyMaxSegmentDuration(v||1);goog.DEBUG&&x.assertIsValid();if(c.manifest_){e.jumpTo(0);break}c.manifest_={presentationTimeline:x,periods:A,offlineSessionIds:[],minBufferTime:p||0};if(!x.usingPresentationStartTime()){e.jumpTo(0);break}F=g.findChildren(a,"UTCTiming");return e.yield(c.parseUtcTiming_(n,
...
for(n=m.next();!n.done;h={channelId:h.channelId},n=m.next()){var v=n.value;n=v.getAttribute("schemeIdUri");v=v.getAttribute("value");"urn:scte:dash:cc:cea-608:2015"==n||"urn:scte:dash:cc:cea-708:2015"==n?(h.channelId=1,null!=v?v.split(";").forEach(function(a){return function(b){if(b.includes("=")){b=b.split("=");var c=b[0].startsWith("CC")?b[0]:"CC"+b[0];b=b[1].split(",")[0].split(":").pop()}else c="CC"+a.channelId,a.channelId+=2;r.set(c,t.normalize(b))}}(h)):r.set("CC1","und")):"urn:mpeg:dash:role:2011"==
n&&null!=v&&(k.push(v),"captions"==v&&(l=e.TextStreamKind.CLOSED_CAPTION))}if(p)return null;e=c.findChildren(b,"ContentProtection");var u=shaka.dash.ContentProtection.parseFromAdaptationSet(e,this.config_.dash.customScheme,this.config_.dash.ignoreDrmInfo);e=shaka.util.LanguageUtils.normalize(b.getAttribute("lang")||"und");h=b.getAttribute("label");(m=c.findChildren(b,"Label"))&&m.length&&(m=m[0],m.textContent&&(h=m.textContent));c=c.findChildren(b,"Representation");k=c.map(this.parseRepresentation_.bind(this,
a,u,l,e,h,g,k,r)).filter(function(a){return!!a});if(0==k.length){if(this.config_.dash.ignoreEmptyAdaptationSet||d)return null;throw new shaka.util.Error(shaka.util.Error.Severity.CRITICAL,shaka.util.Error.Category.MANIFEST,shaka.util.Error.Code.DASH_EMPTY_ADAPTATION_SET);}a.adaptationSet.contentType&&a.adaptationSet.contentType!=f.APPLICATION||(a.adaptationSet.contentType=shaka.dash.DashParser.guessContentType_(k[0].mimeType,k[0].codecs),k.forEach(function(b){b.type=a.adaptationSet.contentType}));
k.forEach(function(a){u.drmInfos.forEach(function(b){a.keyId&&b.keyIds.push(a.keyId)})});f=c.map(function(a){return a.getAttribute("id")}).filter(shaka.util.Functional.isNotNull);return{id:a.adaptationSet.id||"__fake__"+this.globalId_++,contentType:a.adaptationSet.contentType,language:e,main:g,streams:k,drmInfos:u.drmInfos,trickModeFor:q,representationIds:f}};
...
shaka.hls.HlsParser.prototype.parseManifest_=function(a){var b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function d(){var e,f,g,h,k,l,m,n,q,p,t,r,v;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:goog.asserts.assert(b.masterPlaylistUri_,"Master playlist URI must be set before calling parseManifest_!");e=b.manifestTextParser_.parsePlaylist(a,b.masterPlaylistUri_);if(e.type!=shaka.hls.PlaylistType.MASTER)throw new shaka.util.Error(shaka.util.Error.Severity.CRITICAL,
...
t,"to compensate for rollover"),u=$jscomp.makeIterator(b.uriToStreamInfosMap_.values()),w=u.next();!w.done;w=u.next())r=w.value,r.minTimestamp<p?(shaka.log.v1("Offset applied to",r.stream.type),r.stream.presentationTimeOffset=-t,r.segmentIndex.offset(t)):shaka.log.v1("Offset NOT applied to",r.stream.type)}else for(b.presentationTimeline_.setDuration(l),b.presentationTimeline_.offset(-g),u=$jscomp.makeIterator(b.uriToStreamInfosMap_.values()),w=u.next();!w.done;w=u.next())v=w.value,v.stream.presentationTimeOffset=
g,v.segmentIndex.offset(-g),v.segmentIndex.fit(l);b.manifest_={presentationTimeline:b.presentationTimeline_,periods:[f],offlineSessionIds:[],minBufferTime:0};d.jumpToEnd()}})})};
...
shaka.hls.HlsParser.prototype.createStreamInfoFromMediaTag_=function(a,b){var c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){var f,g,h,k,l,m,n,q,p,t,r,v,u;return $jscomp.generator.createGenerator(e,function(e){switch(e.nextAddress){case 1:goog.asserts.assert("EXT-X-MEDIA"==a.name,"Should only be called on media tags!");f=shaka.hls.HlsParser;g=f.getRequiredAttributeValue_(a,"URI");if(c.uriToStreamInfosMap_.has(g))return e["return"](c.uriToStreamInfosMap_.get(g));h=f.getRequiredAttributeValue_(a,
"TYPE").toLowerCase();k=shaka.util.ManifestParserUtils.ContentType;"subtitles"==h&&(h=k.TEXT);l=shaka.util.LanguageUtils;m=l.normalize(a.getAttributeValue("LANGUAGE","und"));n=a.getAttributeValue("NAME");q=a.getAttribute("DEFAULT");p="YES"==q;t=a.getAttributeValue("CHANNELS");r="audio"==h?c.getChannelCount_(t):null;v=a.getAttributeValue("CHARACTERISTICS");return e.yield(c.createStreamInfo_(g,b,h,m,p,n,r,null,v),2);case 2:u=e.yieldResult;if(c.uriToStreamInfosMap_.has(g))return e["return"](c.uriToStreamInfosMap_.get(g));
if(null==u)return e["return"](null);c.mediaTagsToStreamInfosMap_.set(a.id,u);c.uriToStreamInfosMap_.set(g,u);return e["return"](u)}})})};shaka.hls.HlsParser.prototype.getChannelCount_=function(a){if(!a)return null;a=a.split("/")[0];return parseInt(a,10)};
...
shaka.hls.HlsParser.prototype.createStreamInfo_=function(a,b,c,d,e,f,g,h,k){var l=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function n(){var q,p,t,r,v,u,y,w,x,G,D,H,C,z,A,E,F,B,I,K,L,N,M,R,P,Q,S,T;return $jscomp.generator.createGenerator(n,function(n){switch(n.nextAddress){case 1:return q=shaka.hls.Utils,p=q.constructAbsoluteUri(l.masterPlaylistUri_,a),n.yield(l.requestManifest_(p),2);case 2:t=n.yieldResult;p=t.uri;r=l.manifestTextParser_.parsePlaylist(t.data,p);if(r.type!=shaka.hls.PlaylistType.MEDIA)throw new shaka.util.Error(shaka.util.Error.Severity.CRITICAL,
shaka.util.Error.Category.MANIFEST,shaka.util.Error.Code.HLS_INVALID_PLAYLIST_HIERARCHY);v=[];r.segments.forEach(function(a){a=q.filterTagsByName(a.tags,"EXT-X-KEY");v.push.apply(v,a)});u=!1;y=[];w=null;for(var O=$jscomp.makeIterator(v),J=O.next();!J.done;J=O.next())if(x=J.value,G=shaka.hls.HlsParser.getRequiredAttributeValue_(x,"METHOD"),"NONE"!=G){u=!0;if("AES-128"==G)return shaka.log.warning("Unsupported HLS Encryption",G),l.aesEncrypted_=!0,n["return"](null);D=shaka.hls.HlsParser.getRequiredAttributeValue_(x,
"KEYFORMAT");(C=(H=shaka.hls.HlsParser.KEYFORMATS_TO_DRM_PARSERS_[D])?H(x):null)?(C.keyIds.length&&(w=C.keyIds[0]),y.push(C)):shaka.log.warning("Unsupported HLS KEYFORMAT",D)}if(u&&!y.length)throw new shaka.util.Error(shaka.util.Error.Severity.CRITICAL,shaka.util.Error.Category.MANIFEST,shaka.util.Error.Code.HLS_KEYFORMATS_NOT_SUPPORTED);goog.asserts.assert(null!=r.segments,"Media playlist should have segments!");l.determinePresentationType_(r);z=l.guessCodecs_(c,b);return n.yield(l.guessMimeType_(c,
...
shaka.hls.HlsParser.prototype.createSegments_=function(a,b,c,d,e){var f=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function h(){var k,l,m,n,q,p,t,r,v,u,y;return $jscomp.generator.createGenerator(h,function(h){switch(h.nextAddress){case 1:return k=b.segments,l=[],goog.asserts.assert(k.length,"Playlist should have segments!"),m=k[0].absoluteUri,n=f.createSegmentReference_(b,null,k[0],c,0),q=f.createInitSegmentReference_(b),h.yield(f.getStartTime_(a,q,n,d,e),2);case 2:p=h.yieldResult;shaka.log.debug("First segment",
m.split("/").pop(),"starts at",p);for(var w=0;w<k.length;++w)t=k[w],r=l[l.length-1],v=0==w?p:r.endTime,u=c+w,y=f.createSegmentReference_(b,r,t,u,v),l.push(y);f.segmentsToNotifyByStream_.push(l);f.notifySegments_();return h["return"](l)}})})};
...
shaka.hls.HlsParser.prototype.getStartTime_=function(a,b,c,d,e){var f=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function h(){var k,l,m,n,q,p,t,r,v;return $jscomp.generator.createGenerator(h,function(h){switch(h.nextAddress){case 1:if(f.manifest_){k=f.uriToStreamInfosMap_.get(a);l=k.segmentIndex;if(m=l.get(c.position))return shaka.log.v1("Found segment start time in previous manifest"),h["return"](m.startTime);shaka.log.debug("Unable to find segment start time in previous manifest!")}shaka.log.v1("Fetching segment to find start time");
...
case 4:if("application/mp4"!=d&&!d.startsWith("text/")){h.jumpTo(6);break}return h.yield(f.fetchPartialSegment_(c),7);case 7:return v=h.yieldResult,goog.asserts.assert(v.data,"Should have a response body!"),h["return"](f.getStartTimeFromTextSegment_(d,e,v.data));case 6:throw new shaka.util.Error(shaka.util.Error.Severity.CRITICAL,shaka.util.Error.Category.MANIFEST,shaka.util.Error.Code.HLS_COULD_NOT_PARSE_SEGMENT_START_TIME,a);}})})};
...
shaka.hls.HlsParser.prototype.guessMimeType_=function(a,b,c){var d=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function f(){var g,h,k,l,m,n,q,p,t,r,v,u;return $jscomp.generator.createGenerator(f,function(f){switch(f.nextAddress){case 1:g=shaka.util.ManifestParserUtils.ContentType;h=shaka.hls.HlsParser;k=shaka.net.NetworkingEngine.RequestType.SEGMENT;goog.asserts.assert(c.segments.length,"Playlist should have segments!");l=c.segments[0].absoluteUri;m=new goog.Uri(l);n=m.getPath().split(".").pop();
q=h.EXTENSION_MAP_BY_CONTENT_TYPE_[a];if(p=q[n])return f["return"](p);if(a==g.TEXT)return b&&"vtt"!=b&&"wvtt"!=b?f["return"]("application/mp4"):f["return"]("text/vtt");t=shaka.net.NetworkingEngine.makeRequest([l],d.config_.retryParameters);t.method="HEAD";return f.yield(d.makeNetworkRequest_(t,k),2);case 2:return r=f.yieldResult,v=r.headers["content-type"],v?f["return"](v.split(";")[0]):(u=q.mp4,f["return"](u))}})})};
...
shaka.Player.prototype.addTextTrack=function(a,b,c,d,e,f){var g=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function k(){var l,m,n,q,p,t,r,v,u;return $jscomp.generator.createGenerator(k,function(k){switch(k.nextAddress){case 1:if(g.loadMode_==shaka.Player.LoadMode.SRC_EQUALS)throw shaka.log.error("Cannot add text when loaded with src="),Error("State error!");if(g.loadMode_!=shaka.Player.LoadMode.MEDIA_SOURCE)throw shaka.log.error("Must call load() and wait for it to resolve before adding text tracks."),
...
g=c.config_.preferredAudioChannelCount,shaka.util.StreamUtils.chooseCodecsAndFilterManifest(a,g),e.yield(shaka.util.ManifestFilter.rollingFilter(a,function(a){return $jscomp.asyncExecutePromiseGeneratorFunction(function m(){var b,e,f,g,h,k,u,y;return $jscomp.generator.createGenerator(m,function(m){switch(m.nextAddress){case 1:b=shaka.util.StreamUtils;e=[];for(var n=$jscomp.makeIterator(a.variants),p=n.next();!p.done;p=n.next())f=p.value,goog.asserts.assert(b.isPlayable(f),'We should have already filtered by "is playable"'),
e.push(b.variantToTrack(f));n=$jscomp.makeIterator(a.textStreams);for(p=n.next();!p.done;p=n.next())g=p.value,e.push(b.textStreamToTrack(g));return m.yield(c.config_.offline.trackSelectionCallback(e),2);case 2:h=m.yieldResult;k=new Set;u=new Set;n=$jscomp.makeIterator(h);for(p=n.next();!p.done;p=n.next())y=p.value,"variant"==y.type&&k.add(y.id),"text"==y.type&&u.add(y.id);a.variants=a.variants.filter(function(a){return k.has(a.id)});a.textStreams=a.textStreams.filter(function(a){return u.has(a.id)});
m.jumpToEnd()}})})}),2);case 2:shaka.offline.Storage.validateManifest_(a),e.jumpToEnd()}})})};
shaka.offline.Storage.prototype.downloadManifest_=function(a,b,c,d,e){var f=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function h(){var k,l,m,n,q,p,t,r,v,u;return $jscomp.generator.createGenerator(h,function(h){switch(h.nextAddress){case 1:return goog.asserts.assert(f.networkingEngine_,"Cannot call |downloadManifest_| after calling |destroy|."),k=shaka.offline.StoredContentUtils.fromManifest(d,c,0,e),l=c.periods.some(function(a){return a.variants.some(function(a){return a.drmInfos&&
a.drmInfos.length})}),m=c.periods.some(function(a){return a.variants.some(function(a){return a.drmInfos.some(function(a){return a.initData&&a.initData.length})})}),n=l&&!m,q=null,n&&(p=b.getDrmInfo(),q=shaka.offline.Storage.defaultSystemIds_.get(p.keySystem)),t=new shaka.offline.DownloadManager(f.networkingEngine_,function(a,b){k.size=b;f.config_.offline.progressCallback(k,a)},function(a,c){n&&f.config_.offline.usePersistentLicense&&q==c&&b.newInitData("cenc",a)}),h.setFinallyBlock(2),v=r=f.createOfflineManifest_(t,
a,b,c,d,e),h.yield(t.waitToFinish(),4);case 4:v.size=h.yieldResult;r.expiration=b.getExpiration();u=b.getSessionIds();r.sessionIds=f.config_.offline.usePersistentLicense?u:[];if(l&&f.config_.offline.usePersistentLicense&&!u.length)throw new shaka.util.Error(shaka.util.Error.Severity.CRITICAL,shaka.util.Error.Category.STORAGE,shaka.util.Error.Code.NO_INIT_DATA_FOR_OFFLINE);return h["return"](r);case 2:return h.enterFinallyBlock(),h.yield(t.destroy(),5);case 5:h.leaveFinallyBlock(0)}})})};
...
l=Promise.resolve();m={};n=$jscomp.makeIterator(k);for(q=n.next();!q.done;m={sessionIdCell:m.sessionIdCell},q=n.next())m.sessionIdCell=q.value,l=l.then(function(a){return function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function v(){var c,f;return $jscomp.generator.createGenerator(v,function(k){switch(k.nextAddress){case 1:return k.yield(a.sessionIdCell.getAll(),2);case 2:return c=k.yieldResult,k.yield(g["delete"](e,d,c),3);case 3:return f=k.yieldResult,k.yield(a.sessionIdCell.remove(f),
