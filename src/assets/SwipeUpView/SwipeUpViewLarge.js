...
import {styles as barStyles} from './component/Bar';
...
const MARGIN = {
  ...
  OPEN: GlobalStyle.Measurements.safeheight * 0.125,
};
export const SWIPEUP_LARGE_HEIGHT =
  GlobalStyle.Measurements.height -
  MARGIN.OPEN +
  5 -
  barStyles.container.height;

export class SwipeUpViewLarge extends React.Component {
