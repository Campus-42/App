...
import {auth, crashlytics, messaging} from '../../../assets/Firebase/Firebase';
...
import {CampusMapPreview} from './components/CampusMap';
          ...
          {!this.state.searchActive ? (
            <React.Fragment>
              ...
              {(auth.currentUser || {}).uid ==
                'gBq8dxQy6DWU04UIEy0Cz44BFBo2' && (
                <Text style={GlobalStyle.TextStyle.bodyRegular}>
                  Hello Arzu, enjoy the app
                </Text>
              )}
              <EventCarousel
                ref={this.weekRef}
